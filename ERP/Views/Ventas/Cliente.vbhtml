...
<div class="content-wrapper" style="margin-top: 50px">
    ...
    <section class="content-header">
        <h1>Lista de Cliente<small></small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href='@Url.Action("NuevoCliente", "Ventas")' class="btn btn-success">Nuevo Cliente</a></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
